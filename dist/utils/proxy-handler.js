    ...
    set(target, key, value) {
        ...
        if (type === "tuple" || type === "array") {
            ...
            if (typeof value !== "object")
                throw new Error(`${key} expects a Point-like object`);
            if (!value.longitude || !value.latitude)
                throw new Error(`${key} doesnt not have a \`longitude\` and/or \`latitude\``);
            if (Object.keys(value).length > 2)
                throw new Error(`${key} has an invalid amount of keys`);
        }
        else if (type === "text") {
